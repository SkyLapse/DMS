...
namespace Expression.Blend.DataStore.DataStore
{
	...
	public class DataStoreGlobalStorage
	{
		...
		public bool AssignementAllowed
		{
			get
			{
				// Nach Laden nur einmal zuweisen
	...
	public class DataStore : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataStore()
		{
			try
			{
				System.Uri resourceUri = new System.Uri("/Docular.Client.Windows;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
